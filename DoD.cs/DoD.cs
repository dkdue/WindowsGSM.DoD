...
{
    public class DoD : SteamCMDAgent
    {
        // - Plugin Details
        ...
        public override string AppId => "1088320"; // Game server appId

        // - Standard Constructor and properties
        public DoD(ServerConfig serverData) : base(serverData) => base.serverData = _serverData = serverData;
        ...
        {
            string configPath = Functions.ServerPath.GetServersServerFiles(_serverData.ServerID, @"Dragons\Saved\Config\WindowsServer\Game.ini");
        ...
        public async Task<Process> Start()
        {
            ...
            string win64 = Path.Combine(ServerPath.GetServersServerFiles(_serverData.ServerID, @"Dragons\Binaries\Win64\"));
